...
assert.match(p0Source, /const expectedAssetVersion = process\.env\.FENCINGAI_EXPECTED_ASSET_VERSION \|\| 'fencingai-product-20260722-missing-competition-1'/, 'P0 audit must verify the deployed asset version');
